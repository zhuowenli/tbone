...
export default class History extends EventTarget {
    ...
    $_checkOrigin(url) {
        ...
        return (!protocol || this.$_location.protocol === protocol) &&
        (!hostname || this.$_location.hostname === hostname) &&
        ((!hostname && !port) || this.$_location.port === port);
    }

    ...
    methods: {
        ...
        onSelfNodeUpdate() {
            ...
            if (tagName === 'BUILTIN-COMPONENT') {
                ...
                if (builtinComponentName) { checkComponentAttr(this, builtinComponentName, newAttrData); }
                ...
                if (builtinComponentName) { newData.builtinComponentName = builtinComponentName; }
            }

...
module.exports = {
    mode: 'production',
    entry: {
        page1: path.resolve(__dirname, '../src/page1/main.mp.jsx'),
        page2: path.resolve(__dirname, '../src/page2/main.mp.jsx'),
        page3: path.resolve(__dirname, '../src/page3/main.mp.jsx'),
    },
    output: {

<template>
    <!-- className 属性用来测试 -->
    <div className="cnt2">
        <div v-for="item in list" :key="item" class="group">
            ...
            <view class="comp">
                ...
                <div v-else-if="item === 'img'">
                    <img
                        src="https://res.my.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg"
                        width="50"
                        height="50"
                        @load="onImgLoad"
                    >
                ...
                <div v-else-if="item === 'input'">
                    ...
                    <input v-model="input.inputCheckbox" type="checkbox" @input="onInput">
                ...
                <div v-else-if="item === 'label'">
                    ...
                    <input id="input3" name="label-radio" type="radio" @change="onLabelChange">
                    <label>
                        <text>checkbox1</text>
                    ...
                    <input id="input4" type="checkbox" @change="onLabelChange">
                    <label>
                        <text>switch1</text>
                        <template>
                            <BuiltinComponent v-if="!builtinPrefix" behavior="switch" @change="onLabelChange" />
                            <switch v-else class="switch-node" @change="onLabelChange" />
                        </template>
                    </label>
                    <label for="switch2">
                        <text>switch2</text>
                    ...
                    <template>
                        <BuiltinComponent v-if="!builtinPrefix" id="switch2" behavior="switch" @change="onLabelChange" />
                        <switch v-else id="switch2" @change="onLabelChange" />
                    </template>
                </div>
                ...
                <template v-else-if="item === 'view'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item">我是视图</BuiltinComponent>
                    <view v-else-if="builtinPrefix === 1">我是视图</view>
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :hidden="true">我是 hidden 视图</BuiltinComponent>
                    <view v-else-if="builtinPrefix === 1" :hidden="true">我是 hidden 视图</view>
                </template>

                <template v-else-if="item === 'text'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :selectable="true">{{ 'this is first line\nthis is second line' }}</BuiltinComponent>
                ...
                <template v-else-if="item === 'rich-text'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :nodes="richText.nodes" />
                    <RichText v-else-if="builtinPrefix === 1" :nodes="richText.nodes" />
                </template>
                ...
                <div v-else-if="item === 'swiper'" class="swiper">
                    ...
                    >
                        <BuiltinComponent behavior="swiper-item" class="swiper-item-1" item-id="1"><span>A</span></BuiltinComponent>
                        <BuiltinComponent behavior="swiper-item" class="swiper-item-2" item-id="2"><span>B</span></BuiltinComponent>
                        <BuiltinComponent behavior="swiper-item" class="swiper-item-3" item-id="3"><span>C</span></BuiltinComponent>
                        <div>不会被渲染</div>
                    </BuiltinComponent>
                    <Swiper
                        v-else-if="builtinPrefix === 1"
                        :class="item"
                        :indicator-dots="swiper.indicatorDots"
                        :autoplay="swiper.autoplay"
                        :interval="5000"
                        ...
                        @change="onSwiperChange"
                    >
                        <SwiperItem class="swiper-item-1" item-id="1"><span>A</span></SwiperItem>
                        <SwiperItem class="swiper-item-2" item-id="2"><span>B</span></SwiperItem>
                        <SwiperItem class="swiper-item-3" item-id="3"><span>C</span></SwiperItem>
                        <div>不会被渲染</div>
                    </Swiper>
                    <div>
                ...
                <template v-else-if="item === 'movable'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :class="item" :scale-area="true">
                        <BuiltinComponent
                            ref="movable-view"
                            class="movable-view"
                            behavior="movable-view"
                            direction="all"
                            :inertia="true"
                            :out-of-bounds="true"
                            :x="movable.x"
                    ...
                    <MovableArea v-else-if="builtinPrefix === 1" :class="item" :scale-area="true">
                        <MovableView
                            ref="movable-view"
                            class="movable-view"
                            direction="all"
                        ...
                        <MovableView class="movable-view" direction="all" :x="0" :y="0">plaintext</MovableView>
                    </MovableArea>
                ...
                <template v-else-if="item === 'button'">
                    <!-- className 属性用来测试 -->
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" className="button-custom" open-type="share">分享</BuiltinComponent>
                    <button v-else-if="builtinPrefix === 1" className="button-custom" open-type="share">分享</button>

                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" open-type="getPhoneNumber" @getphonenumber="onGetPhoneNumber">获取手机号</BuiltinComponent>
                    <button v-else-if="builtinPrefix === 1" open-type="getPhoneNumber" @getphonenumber="onGetPhoneNumber">获取手机号</button>

                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item">
                        <span>span1</span>
                        <input type="checkbox">
                        <span>span2</span>
                    </BuiltinComponent>
                ...
                <template v-else-if="item === 'image'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" src="https://res.my.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg" />
                    <image v-else-if="builtinPrefix === 1" src="https://res.my.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg" />
                </template>
                <template v-else-if="item === 'icon'">
                    <div v-if="!builtinPrefix">
                        <div>
                            <BuiltinComponent
                                v-for="subItem in icon.size"
                                :key="subItem"
                                :behavior="item"
                                type="success"
                                :size="subItem"
                    ...
                    <div v-else-if="builtinPrefix === 1">
                        <div><Icon v-for="subItem in icon.size" :key="subItem" type="success" :size="subItem" /></div>
                        <div>
                            <Icon
                                v-for="subItem in icon.color"
                                :key="subItem"
                        ...
                        <div><Icon v-for="subItem in icon.type" :key="subItem" :type="subItem" size="40" /></div>
                    </div>
                </template>
                <template v-else-if="item === 'progress'">
                    <div v-if="!builtinPrefix">
                        <BuiltinComponent :behavior="item" percent="20" :show-info="true" />
                        <BuiltinComponent :behavior="item" percent="40" stroke-width="12" />
                        <BuiltinComponent :behavior="item" percent="60" color="pink" />
                        <BuiltinComponent :behavior="item" percent="80" :active="true" />
                    </div>
                    <div v-else-if="builtinPrefix === 1">
                ...
                <template v-else-if="item === 'navigator'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" target="miniapp" open-type="exit">退出小程序</BuiltinComponent>
                    <Navigator v-else-if="builtinPrefix === 1" target="miniapp" open-type="exit">退出小程序</Navigator>
                </template>
                <template v-else-if="item === 'picker'">
                    <div v-if="!builtinPrefix">
                        <BuiltinComponent :behavior="item" :value="1" :range="['美国', '中国', '巴西', '日本']" @change="onPickerChange">点击&nbsp;&nbsp;选择国家</BuiltinComponent>
                    </div>
                    <div v-else-if="builtinPrefix === 1">
                ...
                <template v-else-if="item === 'picker-view'">
                    ...
                    <div v-if="!builtinPrefix">
                        <BuiltinComponent
                            ...
                            :value="pickerView.value"
                            @change="onPickerViewChange"
                        >
                            <BuiltinComponent behavior="picker-view-column">
                    ...
                    <div v-else-if="builtinPrefix === 1">
                        <PickerView indicator-style="height: 50px;" style="width: 100%; height: 300px;" :value="pickerView.value" @change="onPickerViewChange">
                            <PickerViewColumn>
                                <view v-for="item in pickerView.years" :key="item" class="picker-view-item"><text>{{ item }}年</text></view>
                            </PickerViewColumn>
                            <PickerViewColumn>
                                <view v-for="item in pickerView.months" :key="item" class="picker-view-item"><text>{{ item }}月</text></view>
                            </PickerViewColumn>
                            <PickerViewColumn>
                                <view v-for="item in pickerView.days" :key="item" class="picker-view-item"><text>{{ item }}日</text></view>
                            </PickerViewColumn>
                        </PickerView>
                    </div>
                </template>
                ...
                <template v-else-if="item === 'switch'">
                    <div v-if="!builtinPrefix">
                        <BuiltinComponent :behavior="item" type="switch" :checked="true" @change="onSwitchChange" />
                        <BuiltinComponent :behavior="item" type="checkbox" @change="onSwitchChange" />
                    </div>
                    <div v-else-if="builtinPrefix === 1">
                        <switch type="switch" :checked="true" @change="onSwitchChange" />
                        <switch type="checkbox" @change="onSwitchChange" />
                    </div>
                </template>
                ...
                <template v-else-if="item === 'cover-view'">
                    ...
                    <CoverView v-else-if="builtinPrefix === 1">测试 cover-view</CoverView>
                </template>
                <template v-else-if="item === 'cover-image'">
                    <BuiltinComponent v-if="!builtinPrefix" behavior="cover-view">
                        <BuiltinComponent :behavior="item" src="https://res.my.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg" />
                    </BuiltinComponent>
                    <CoverView v-else-if="builtinPrefix === 1">
                        <CoverImage src="https://res.my.qq.com/wxdoc/dist/assets/img/0.4cb08bb4.jpg" />
                    </CoverView>
                </template>
                ...
                <template v-else-if="item === 'camera'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :class="item">
                        <Inner />
                    </BuiltinComponent>
                ...
                <template v-else-if="item === 'ad'">
                    <BuiltinComponent
                        ...
                        @error="onAdError"
                    />
                    <Ad v-else-if="builtinPrefix === 1" :class="item" unit-id="123" @error="onAdError" />
                </template>
                <template v-else-if="item === 'official-account'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :class="item" @error="onOfficialAccountError" />
                    <OfficialAccount v-else-if="builtinPrefix === 1" :class="item" @error="onOfficialAccountError" />
                </template>

                <template v-else-if="item === 'web-view'">
                    <BuiltinComponent v-if="!builtinPrefix" :behavior="item" :class="item" src="https://www.taobao.com/" />
                    <WebView v-else-if="builtinPrefix === 1" :class="item" src="https://www.taobao.com/" />
                </template>
                ...
                <template v-else-if="item === 'scroll-view'">
                    <div>
                        <BuiltinComponent
                            ...
                            :behavior="item"
                            :class="item + '-y'"
                            :scroll-into-view="'y1' + scrollView.yDest"
                            :scroll-top="scrollView.scrollTop"
                            :scroll-y="true"
                            :scroll-with-animation="scrollView.yAnimation"
                        ...
                        <ScrollView
                            ...
                            ref="scroll-view"
                            :class="item + '-y'"
                            :scroll-into-view="'y2' + scrollView.yDest"
                            :scroll-top="scrollView.scrollTop"
                            :scroll-y="true"
                            :scroll-with-animation="scrollView.yAnimation"
                            @scroll="onScrollViewScroll"
                    ...
                    <div>
                        <BuiltinComponent
                            ...
                            :behavior="item"
                            :class="item + '-x'"
                            :scroll-into-view="'x1' + scrollView.xDest"
                            :scroll-x="true"
                        ...
                        <ScrollView
                            ...
                            ref="scroll-view"
                            :class="item + '-x'"
                            :scroll-into-view="'x2' + scrollView.xDest"
                            :scroll-x="true"
                            :scroll-with-animation="true"
                            @scroll="onScrollViewScroll"
                        >

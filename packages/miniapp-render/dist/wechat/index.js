    ...
    _proto.$$getContext = function $$getContext() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this4.tagName === 'CANVAS') {
          ...
          wx.createSelectorQuery().in(_this4._builtInComponent).select(".node-" + _this4.$_nodeId).context(function (res) {
    ...
    _proto.$$getNodesRef = function $$getNodesRef() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this5.tagName === 'CANVAS') {
          // TODO, for the sake of compatibility with a bug in the underlying library, for the time being
          resolve(wx.createSelectorQuery().in(_this5._builtInComponent).select(".node-" + _this5.$_nodeId));
        } else {
